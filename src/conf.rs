...
//! [`lokinit::start`](../fn.start.html), but the framebuffer sizes returned by [`Context::screen_size`](../graphics/struct.Context.html#method.screen_size)
...
pub struct Platform {
    ...
    /// Wayland or X11. Defaults to X11WithWaylandFallback - lokinit will try
